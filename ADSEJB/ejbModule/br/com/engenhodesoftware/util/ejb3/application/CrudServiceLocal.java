...
public interface CrudServiceLocal<T extends PersistentObject> extends Serializable {
	 ...
	 * 
	 * @param entity
	 *		Entity object coming from the presentation layer, containing the data that is going to be sent to the create()
	 ...
	 * 
	 * @param entity
	 *		Entity object coming from the presentation layer, containing the ID of the existing entity and the data, both of
	 *		which are going to be sent to the update() method for entity update.
	 *
	 * @throws Exception
	 *		In case business constraints aren't followed.
	 */
	 ...
	 * 
	 * @param entity
	 *		Entity object coming from the presentation layer, containing the ID of the existing entity that is going to be
	 *		sent to the delete() method for entity deletion.
	 *
	 * @throws Exception
	 *		In case business constraints aren't followed.
	 */
